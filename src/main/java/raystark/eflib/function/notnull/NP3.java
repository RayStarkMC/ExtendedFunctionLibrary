 ...
 *
 * <p>このインターフェースは{@link NP3#test}を関数メソッドに持つ関数型インターフェースです。
 * <p>この関数はnullを扱いません。
 *
 * <p>オーバーライドされた{@link NF3}のメソッドの内、関数を返すものは対応する述語を返します。
 *
 ...
 */
@FunctionalInterface
public interface NP3<T1, T2, T3> extends NF3<T1, T2, T3, Boolean> {
    /**
     * 指定された引数でこの述語を評価します。
     *
     * @param t1 第一引数
     ...
     */
    boolean test(@NotNull T1 t1, @NotNull T2 t2, @NotNull T3 t3);

    /**
     * 指定された引数でこの述語を評価します。
     *
     * <p>このメソッドは{@link NP3#test}の結果をBoolean型にラップします。
     *
     * @param t1 第一引数
     * @param t2 第二引数
     * @param t3 第三引数
    ...
    @Override
    @NotNull
    default Boolean apply(@NotNull T1 t1, @NotNull T2 t2, @NotNull T3 t3) {
    ...
    @Override
    @NotNull
    default NP2<T2, T3> apply(@NotNull T1 t1) {
     ...
     */
    @NotNull
    default NP3<T1, T2, T3> and(@NotNull NP3<? super T1, ? super T2, ? super T3> other) {
     ...
     */
    @NotNull
    default NP3<T1, T2, T3> or(@NotNull NP3<? super T1, ? super T2, ? super T3> other) {
        return (t1, t2, t3) -> test(t1, t2, t3) || other.test(t1, t2, t3);
    }
    ...
    @Override
    @NotNull
    default <V1> NP3<V1, T2, T3> compose1(@NotNull NF1<? super V1, ? extends T1> before) {
    ...
    @Override
    @NotNull
    default <V2> NP3<T1, V2, T3> compose2(@NotNull NF1<? super V2, ? extends T2> before) {
    ...
    @Override
    @NotNull
    default <V3> NP3<T1, T2, V3> compose3(@NotNull NF1<? super V3, ? extends T3> before) {
     ...
     *
     * <pre>{@code
     *  NP3<T1, T2, T3> p1 = NP3.of((T1 t1, T2 t2, T3 t3) -> SomeClass1.someMethod(t1, t2, t3)).and(SomeClass2::someMethod);
     *  NP3<T1, T2, T3> p2 = NP3.<T1, T2, T3>of(SomeClass1::someMethod).then1(SomeClass2::someMethod);
     * }</pre>
     *
     ...
     */
    @NotNull
    static <T1, T2, T3> NP3<T1, T2, T3> of(@NotNull NP3<T1, T2, T3> p3) {
        return p3;
    }
    ...
    @NotNull
    static <T1, T2, T3> NP3<T1, T2, T3> cast(@NotNull NP3<? super T1, ? super T2, ? super T3> p3) {
        return (NP3<T1, T2, T3>) p3;
    }
}
