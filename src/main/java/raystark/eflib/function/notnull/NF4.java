 ...
 *
 * <p>このインターフェースは{@link NF4#apply}を関数メソッドに持つ関数型インターフェースです。
 * <p>この関数はnullを扱いません。
 *
 ...
 */
@FunctionalInterface
public interface NF4<T1, T2, T3, T4, R> extends NF3<T1, T2, T3, NF1<T4, R>> {
    /**
     ...
     */
    @NotNull
    R apply(@NotNull T1 t1, @NotNull T2 t2, @NotNull T3 t3, @NotNull T4 t4);
    ...
    @NotNull
    @Override
    default NF1<T4, R> apply(@NotNull T1 t1, @NotNull T2 t2, @NotNull T3 t3) {
     ...
     */
    @NotNull
    default NF1<T4, R> apply(@NotNull NS<? extends T1> t1, @NotNull NS<? extends T2> t2, @NotNull NS<? extends T3> t3) {
        return t4 -> apply(t1.get(), t2.get(), t3.get(), t4);
    }
     ...
     */
    @NotNull
    default <V> NF4<T1, T2, T3, T4, V> then4(@NotNull NF1<? super R, ? extends V> after) {
    ...
    @Override
    @NotNull
    default <V1> NF4<V1, T2, T3, T4, R> compose1(@NotNull NF1<? super V1, ? extends T1> before) {
    ...
    @Override
    @NotNull
    default <V2> NF4<T1, V2, T3, T4, R> compose2(@NotNull NF1<? super V2, ? extends T2> before) {
    ...
    @Override
    @NotNull
    default <V3> NF4<T1, T2, V3, T4, R> compose3(@NotNull NF1<? super V3, ? extends T3> before) {
     ...
     */
    @NotNull
    default <V4> NF4<T1, T2, T3, V4, R> compose4(@NotNull NF1<? super V4, ? extends T4> before) {
    ...
    @Override
    @NotNull
    default NF4<T2, T1, T3, T4, R> swap2() {
    ...
    @Override
    @NotNull
    default NF4<T3, T2, T1, T4, R> swap3() {
     ...
     */
    @NotNull
    default NF4<T4, T2, T3, T1, R> swap4() {
     ...
     */
    @NotNull
    default NP4<T1, T2, T3, T4> asP4(@NotNull NP1<? super R> after) {
     ...
     */
    @NotNull
    default NS<R> asS(@NotNull T1 t1, @NotNull T2 t2, @NotNull T3 t3, @NotNull T4 t4) {
     ...
     */
    @NotNull
    default NS<R> asS(@NotNull NS<? extends T1> t1, @NotNull NS<? extends T2> t2, @NotNull NS<? extends T3> t3, @NotNull NS<? extends T4> t4) {
        return () -> apply(t1.get(), t2.get(), t3.get(), t4.get());
    }
     ...
     */
    @NotNull
    default NC4<T1, T2, T3, T4> asC4(@NotNull NC1<? super R> after) {
     ...
     *
     * <pre>{@code
     *  NF4<T1, T2, T3, T4, R> f1 = NF4.of((T1 t1, T2 t2, T3 t3, T4 t4) -> SomeClass1.someMethod(t1, t2, t3, t4)).then1(SomeClass2::someMethod);
     *  NF4<T1, T2, T3, T4, R> f2 = NF4.<T1, T2, T3, T4, SomeType>of(SomeClass1::someMethod).then1(SomeClass2::someMethod);
     * }</pre>
     *
