 ...
 *
 * <p>このインターフェースは{@link NRC4#accept(T1, T2, T3, T4, NRC4)}を関数メソッドに持つ関数型インターフェースです。
 *
...
public interface NRC4<T1, T2, T3, T4> {
     ...
     *
     * <p>再帰的ラムダ式では{@link VoidTailCall#call}に渡すSupplierの中でselfを参照し、{@link NRC4#accept(T1, T2, T3, T4)}メソッドを呼び出してください。
     *
     * @param t1 第一引数
     * @param t2 第二引数
     * @param t3 第三引数
     ...
     *
     * <p>この実装では{@link NRC4#accept(T1, T2, T3, T4, NRC4)}メソッドに引数と関数自身を渡します。
     *
     * @param t1 第一引数
     * @param t2 第二引数
     * @param t3 第三引数
