...
public interface RP4<T1, T2, T3, T4> {
    ...
    @NotNull
    static <T1, T2, T3, T4> P4<T1, T2, T3, T4> of(@NotNull TailCallP4<T1, T2, T3, T4> rp4) {
        return (t1, t2, t3, t4) -> rp4.test(t1, t2, t3, t4).evaluate();
    }

    @FunctionalInterface
    interface TailCallP4<T1, T2, T3, T4> {
        @NotNull
        BooleanTailCall test(@Nullable T1 t1, @Nullable T2 t2, @Nullable T3 t3, @Nullable T4 t4);
    }
}
