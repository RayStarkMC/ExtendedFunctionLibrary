 ...
 *
 * <p>このインターフェースは{@link RP4#test}を関数メソッドに持つ関数型インターフェースです。
 *
...
public interface RP4<T1, T2, T3, T4> {
     ...
     *
     * <p>再帰的ラムダ式では{@link BooleanTailCall#call}に渡すSupplierの中でselfを参照し、{@link RP4#test}メソッドを呼び出してください。
     *
     * @param t1 第一引数
     * @param t2 第二引数
     * @param t3 第三引数
     ...
     * 指定された引数でこの述語を評価します。
     *
     * <p>この実装では{@link RP4#test}メソッドに引数と関数自身を渡します。
     *
     * @param t1 第一引数
     * @param t2 第二引数
     * @param t3 第三引数
     ...
     * {@link BooleanTailCall#evaluate}の実行は{@link P4#test}の実行まで遅延されます。
     *
