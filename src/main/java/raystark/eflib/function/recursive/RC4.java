 ...
 *
 * <p>このインターフェースは{@link RC4#accept}を関数メソッドに持つ関数型インターフェースです。
 *
...
public interface RC4<T1, T2, T3, T4> {
     ...
     *
     * <p>再帰的ラムダ式では{@link VoidTailCall#call}に渡すSupplierの中でselfを参照し、{@link RC4#accept}メソッドを呼び出してください。
     *
     * @param t1 第一引数
     * @param t2 第二引数
     * @param t3 第三引数
     ...
     *
     * <p>この実装では{@link RC4#accept}メソッドに引数と関数自身を渡します。
     *
     * @param t1 第一引数
     * @param t2 第二引数
     * @param t3 第三引数
     ...
     * {@link VoidTailCall#execute}の実行は{@link C4#accept}の実行まで遅延されます。
     *
