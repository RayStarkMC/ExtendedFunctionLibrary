...
public interface Acceptor3<T extends Acceptor3<T, T1, T2, T3>, T1 extends T, T2 extends T, T3 extends T> {
    ...
    MonoDispatcher3<T, T1, T2, T3, R> definedVisitor3(@NotNull NF1<MonoDefinition3.BuilderT1<T, T1, T2, T3, R>, MonoDefinition3<T, T1, T2, T3, R>> builderProcess) {
        return MonoDispatcher3.build(builderProcess);
    }

    static <T extends Acceptor3<T, T1, T2, T3>, T1 extends T, T2 extends T, T3 extends T, R>
    DiDispatcher3<T, T1, T2, T3, R> definedDiVisitor3(@NotNull NF1<DiDefinition3.BuilderT11<T, T1, T2, T3, R>, DiDefinition3<T, T1, T2, T3, R>> builderProcess) {
